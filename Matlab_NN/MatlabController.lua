...
while true do
	...
	print(displayBoard())
	writeData(displayBoard(), "/home/matkam11/ML/Matlab_NN/inputData.txt")
	flagSet = io.open("/home/matkam11/ML/Matlab_NN/flag.txt","w")
	flagSet:write("1")
	flagSet:close();

	while (1) do

		flagSet=io.open("/home/matkam11/ML/Matlab_NN/flag.txt","r");
	...
	outFile=io.open("/home/matkam11/ML/Matlab_NN/output.txt","r");
